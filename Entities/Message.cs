...
namespace API.Entities
{
    public class Message
    {
        ...
        public Boolean RecipientDeleted { get; set; } // Whether the recipient has deleted the message
        public Boolean SenderDeleted { get; set; } // Whether the sender has deleted the message
    }
}